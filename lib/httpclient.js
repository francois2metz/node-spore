 ...
 *  - payload
 */
function Request(httpClient, parsedUrl, method, headers, params, payload) {
...
exports.createRequest = function(httpClient, parsedUrl, method, headers, params, payload) {
    return new Request(httpClient, parsedUrl, method, headers, params, payload);
};
